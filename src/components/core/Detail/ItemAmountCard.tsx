...
const ItemAmountCard = () => {
  ...
  return (
    <View style={styles.container}>
      <TouchableWithoutFeedback disabled={amount <= 1} style={styles.cardButton} onPress={() => setAmount(amount - 1)}>
        <Feather name="minus" size={18} color="#F0FFF0" />
      </TouchableWithoutFeedback>
      <Text style={styles.cardText}>{amount}</Text>
      <TouchableWithoutFeedback style={styles.cardButton} onPress={() => setAmount(amount + 1)}>
