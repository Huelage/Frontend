...
const Referral = () => {
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top, backgroundColor: color.mainBg }]} onTouchStart={dismissKeyboard} testID="Referral screen">
      <View style={styles.headerBox}>
        ...
        <Text style={[styles.headerText, { color: color.mainText }]}>Referral</Text>
      </View>
