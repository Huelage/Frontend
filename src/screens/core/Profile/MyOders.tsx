...
const MyOrders = () => {
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top, backgroundColor: color.mainBg }]} onTouchStart={dismissKeyboard} testID="MyOrders screen">
      <View style={styles.headerBox}>
        ...
        <Text style={[styles.headerText, { color: color.mainText }]}>MyOrders</Text>
      </View>
