...
const FAQs = () => {
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top, backgroundColor: color.mainBg }]} onTouchStart={dismissKeyboard} testID="FAQs screen">
      <View style={styles.headerBox}>
        ...
        <Text style={[styles.headerText, { color: color.mainText }]}>FAQs</Text>
      </View>
