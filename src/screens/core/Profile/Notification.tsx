...
const Notification = () => {
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top, backgroundColor: color.mainBg }]} onTouchStart={dismissKeyboard} testID="Notification screen">
      <View style={styles.headerBox}>
        ...
        <Text style={[styles.headerText, { color: color.mainText }]}>Notification</Text>
      </View>
